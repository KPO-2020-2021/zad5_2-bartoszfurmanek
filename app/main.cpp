...
int main() {
    ...
    Sc.DodajPrzeszkode(1, {100,100,0}, 0, {10,10,5}, "Plaskowyz1");
    Sc.DodajPrzeszkode(2, {50,150,0}, 0, {40,10,40}, "GoraZGrania1");
    Sc.DodajPrzeszkode(3, {150,50,0}, 0, {20,20,100}, "GoraZeszczytem1");
